...
const navigation = [
  { name: 'My Processed Batches', href: '/pressing/batches', icon: Package },
  { name: 'Log Storage Before Pressing', href: '/pressing/storage-before', icon: Box },
  { name: 'Log Pressing Process', href: '/pressing/log', icon: LogIn },
  { name: 'Log Storage After Pressing', href: '/pressing/storage-after', icon: Box },
  { name: 'View a Batch', href: '/pressing/find', icon: Search },
];
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-40 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-gray-900">Pressing Operations</span>
          </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="bg-gradient-to-br from-rose-50 to-purple-50 rounded-lg p-4 mb-4">
              <p className="text-sm font-medium text-gray-900 mb-1">
                {user?.email || 'Pressing Operator'}
              </p>
              <p className="text-xs text-gray-600">Pressing Operations</p>
            </div>
            <button

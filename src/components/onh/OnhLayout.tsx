...
const navigation = [
  { name: 'My Quality Batches', href: '/onh/batches', icon: Package },
  { name: 'View a Batch', href: '/onh/find', icon: Search },
  { name: 'Log Quality Check', href: '/onh/log', icon: FlaskConical },
];

export default function OnhLayout() {
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-200 z-40 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-gray-900">ONH Operations</span>
          </div>
